                         ...
                         const std::map<std::string, std::variant<int, float, std::string>> &dictionary)
{
    ...
    // Handle photons (massless particles) separately - FIXED
...
void VectorLept_withoutNC(const std::string &input_file)
{
    ...
    std::string Output_Root_file = add_file + "VectorLeptWithoutNC_eventnum_" + num_events_str + "_" + proton_num_str + "p" + pion_num_str + "pi.root";

    TFile *treefile = new TFile(Output_Root_file.c_str(), "RECREATE");

    std::string output_name = std::get<std::string>(dictionary["OUTPUT_NAME"]);
    std::string outfile_name = output_name + "VectorLeptWithoutNC_eventnum_" + num_events_str + "_" + proton_num_str + "p" + pion_num_str + "pi.csv";
    ...
    std::string directory = output_directory + "VectorLeptWithoutNC_eventnum_" + num_events_str + "_" + proton_num_str + "p" + pion_num_str + "pi";
