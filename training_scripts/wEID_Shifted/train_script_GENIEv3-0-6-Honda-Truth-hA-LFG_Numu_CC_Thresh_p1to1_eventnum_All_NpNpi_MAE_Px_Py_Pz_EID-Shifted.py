...
with open("/home/jbarrow/Transformer/transformer_EE/transformer_ee/config/wEID_Shifted/input_GENIEv3-0-6-Honda-Truth-hA-LFG_Numu_CC_Thresh_p1to1_eventnum_All_NpNpi_MAE_Px_Py_Pz_EID-Shifted.json", encoding="UTF-8", mode="r") as f:
    input_d = json.load(f)
...
input_d["save_path"] = "/exp/dune/data/users/jbarrow/save_genie-TEST/model/test/GENIEv3-0-6-Honda-Truth-hA-LFG_Numu_CC_Thresh_p1to1_eventnum_All_NpNpi_MAE_Px_Py_Pz_EID-Shifted2"
#input_d["save_path"] = "/home/cborden/git/richi_transformer_EE/save/model/test"

input_d["dataframe_type"] = "polars"

my_logger = WandBLogger(project="GENIE_Atmo",entity="neutrinoenenergyestimators", config=input_d, dir="/exp/dune/data/users/jbarrow/save_genie-TEST/wandb", id="GENIEv3-0-6-Honda-Truth-hA-LFG_Numu_CC_Thresh_p1to1_eventnum_All_NpNpi_MAE_Px_Py_Pz_EID-Shifted2")
